    ...
    public partial class MainWindow : WindowBase, IWithProcessRing
    {
        ...
        public Project SelectedProject
        {
            ...
            set
            {
                ...
                TitleBar.SelectedProject = value;
        ...
        public TitleBarBase TitleBar { get; set; }
        public void SetTitleBar()
        {
            TitleBar = Configs.TitleBarLine == 1 ? new SingleLineTitleBar() as TitleBarBase : new TwoLineTitleBar();
            TitleBar.AddProjectButtonClick += AddProjectButton_Click;
            TitleBar.SelectedProjectChanged += title_SelectedProjectChanged;
            TitleBar.SelectedViewPanelChanged += ListBox_SelectionChanged;
            TitleBar.Projects = Projects;
            TitleBar.SelectedProject = SelectedProject;
            this.Notify(nameof(TitleBar));
        }
        public MainWindow()
        {
        ...
        private void title_SelectedProjectChanged(object sender, EventArgs e)
        {
            if (SelectedProject != TitleBar.SelectedProject && IsLoaded)
            {
                SelectedProject = TitleBar.SelectedProject;
            }
        }
    }
}
